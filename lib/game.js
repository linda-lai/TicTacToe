...
const checkWin = (playerMarker, currentBoard) => {
  if (currentBoard['11'] === playerMarker && currentBoard['12'] === playerMarker && currentBoard['13']) {
    return true
    ...
    return true
  } else if (currentBoard['11'] === playerMarker && currentBoard['21'] === playerMarker && currentBoard['31']) {
    return true
    ...
    return true
  } else if (currentBoard['11'] === playerMarker && currentBoard['22'] === playerMarker && currentBoard['33']) {
    true
